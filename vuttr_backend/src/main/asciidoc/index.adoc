...
include::{snippets}/tools-api/get-tools-with-no-parameter/curl-request.adoc[]

[[resources-tool-get-tools-with-no-parameter-http-response]]
==== Sample HTTP Response

include::{snippets}/tools-api/get-tools-with-no-parameter/http-response.adoc[]

[[resources-tool-get-tools-with-no-parameter-response-fields]]
==== Response Fields

include::{snippets}/tools-api/get-tools-with-no-parameter/response-fields.adoc[]